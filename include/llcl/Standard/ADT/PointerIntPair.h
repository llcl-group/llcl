#ifndef LLCL_STANDARD_ADT_POINTERINTPAIR_H
#define LLCL_STANDARD_ADT_POINTERINTPAIR_H
...
#include "llcl/Standard/Support/PointerLikeTypeTraits.h"
#include "llcl/Standard/Support/type_traits.h"
...
template <typename PointerTy, unsigned IntBits, typename IntType,
          typename PtrTraits, typename Info>
struct tuple_size<
    llcl::PointerIntPair<PointerTy, IntBits, IntType, PtrTraits, Info>>
    : std::integral_constant<std::size_t, 2> {};

template <std::size_t I, typename PointerTy, unsigned IntBits, typename IntType,
          typename PtrTraits, typename Info>
struct tuple_element<
    I, llcl::PointerIntPair<PointerTy, IntBits, IntType, PtrTraits, Info>>
    : std::conditional<I == 0, PointerTy, IntType> {};
}  // namespace std

#endif  // LLCL_STANDARD_ADT_POINTERINTPAIR_H